...
console.log(personalMovieDB);// выводит свойства объекта в консоли
...
function writeYourGenres(one, two, three) {
    for (let i = 1; i <= 3; i++) {
...
console.log(personalMovieDB.genres());// выводит свойства объекта в консоли